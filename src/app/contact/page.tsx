...
const paymentMethods = [
    ...
    },
    {
        ...
        details: "Transfer to: XX XXX XXX",
    },
    {
        id: "PAYPAL",
        name: "PayPal",
        ...
        details: "Send to: email@example.com",
    },
    {
        id: "CRYPTO",
        name: "Crypto",
        ...
        details: "Wallet: TXXXXXXXXXXXXXXXXXXXXXXX",
    },
    {
        id: "FLOUCI",
        name: "Flouci",
                        ...
                        {step === "instructions" && selectedPaymentMethod && (
                            <div className="space-y-6 animate-fade-in">
                                ...
                                <div className="text-center mb-6">
                                    <p className="text-muted-foreground">{t("topup.sendInstruction")} <strong className="text-primary">{amount} TND</strong> {t("topup.via")} <strong>{selectedPaymentMethod.name}</strong></p>
                                </div>
                                ...
                                <div className="p-6 rounded-xl bg-muted/30 border border-border relative overflow-hidden">
                                    ...
                                    <div className="flex items-center justify-between gap-4 bg-background p-3 rounded-lg border border-border/50">
                                        <code className="text-lg font-mono text-foreground">{selectedPaymentMethod.details.split(": ")[1]}</code>
                                        <button
