...
import { Menu, X, ShoppingCart, User, LogOut, LayoutDashboard, Globe, ChevronDown } from "lucide-react"
...
export function Header() {
    ...
    return (
        ...
        >
                        ...
                        {navLinks.map((link) => (
                            <Link
                                ...
                                className={`relative px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 ${isPillMode
                                        ...
                                        : 'text-[#a1a1aa] hover:text-[#fafafa] bg-[#151515]/50 border border-[#262626]/50 hover:bg-[#262626]'
                                    }`}
                                style={{
            ...
            {/* Mobile Menu (unchanged structure, just styling) */}
            {mobileMenuOpen && (
